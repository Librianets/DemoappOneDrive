...
////////////////////////////
	...
	lpArgv = CommandLineToArgvW(lpszCmdParam, &iArgc);
	...
	hInetRequest = HttpOpenRequestW(hInetSession, L"POST", aRequest, HTTP_VERSION, NULL, 0, INTERNET_FLAG_SECURE | INTERNET_FLAG_NO_AUTH | INTERNET_FLAG_KEEP_CONNECTION, 0);
